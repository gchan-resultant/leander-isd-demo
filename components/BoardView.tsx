...
import { LineChart, Line, BarChart, Bar, ScatterChart, Scatter, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, ReferenceLine, Cell, ZAxis } from 'recharts';
import { TrendingUp, Target, Users, Info, Sparkles, ChevronDown, MousePointerClick, AlertTriangle } from 'lucide-react';
...
const BoardView: React.FC = () => {
  ...
  const boardContext = `
    ...
    4. Teacher Turnover vs Growth Analysis (Math): ${JSON.stringify(BOARD_TURNOVER_DATA)}. 
       Note: 'cost' is estimated replacement cost in USD.
    
    Functionalities:
    - Summarize progress toward goals.
    - Identify specific sub-populations requiring resources.
    - Analyze correlation between teacher turnover and student growth.
          ...
          <div className="p-6 max-w-7xl mx-auto pb-24 space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <Sparkles size={18} className="text-vt-gold"/> Launch EdAssist AI
                    </button>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-100 rounded-xl p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-3">
                        <Sparkles className="text-vt-blue" size={20} />
                        <h2 className="font-bold text-vt-blue">Executive Summary (Generated by EdAssist)</h2>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h3 className="font-bold text-lg text-gray-800 group-hover:text-vt-blue transition">District Longitudinal Growth</h3>
                            <p className="text-sm text-gray-500">Comparison: District Avg vs. National Norm (Mean RIT)</p>
                        </div>
                        <div className="p-2 bg-blue-50 text-vt-blue rounded-lg"><TrendingUp size={20}/></div>
                    </div>
                    ...
                    <div className="h-80 w-full pointer-events-none">
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={BOARD_ASSESSMENT_TRENDS} margin={{top: 10, right: 30, left: 0, bottom: 0}}>
                                ...
                                <Line name="District Avg" type="monotone" dataKey="district" stroke="#004f8a" strokeWidth={3} activeDot={{r: 6}} />
                ...
                {/* Teacher Turnover vs Growth - NEW CHART */}
                <div 
                    onClick={() => launchAi("Which campuses are showing the highest correlation between high teacher turnover and low student growth in specific subject areas, and what is the estimated cost of replacing those teachers?")}
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h3 className="font-bold text-lg text-gray-800 group-hover:text-orange-600 transition">Teacher Turnover Impact on Student Growth</h3>
                            <p className="text-sm text-gray-500">Correlation: Turnover Rate vs. Avg Student Growth (Bubble Size = Replacement Cost)</p>
                        </div>
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                        ...
                        <button className="text-vt-blue text-sm font-medium hover:underline">Download Full Report</button>
                    </div>
